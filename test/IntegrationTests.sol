...
contract IntegrationTests is Test {
    ...
    // Helper: deposit collateral for public groups (5x contribution for MAX_MEMBERS=5)
    ...
    function testThriftGroup_CompleteFlow() public {
        // Deposit collateral for owner and user1 (5x contribution = 500 ether)
        _depositCollateral(address(this), 500 ether);
    ...
    function testThriftGroup_MultipleCycles() public {
        // Deposit collateral for all participants (5x contribution = 500 ether)
        _depositCollateral(address(this), 500 ether);
        _depositCollateral(user1, 500 ether);
    ...
    function testThriftGroup_LeaveGroupFlow() public {
        // Deposit collateral for owner and user1
        _depositCollateral(address(this), 500 ether);
        _depositCollateral(user1, 500 ether);
    ...
    */
    ...
    function testMiniSafe_CreateThriftGroup_EdgeCases() public {
        ...
        // Deposit collateral for user1 (5x contribution = 0.5 ether)
        _depositCollateral(user1, 0.5 ether);
    ...
    function testMiniSafe_AdvancedFlows() public {
        ...
        // Deposit collateral for user1 and user2 (5x contribution = 500 ether)
        _depositCollateral(user1, 500 ether);
        _depositCollateral(user2, 500 ether);
