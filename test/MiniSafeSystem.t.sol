...
contract MiniSafeTokenStorageUpgradeableTest is Test {
    ...
    function testAddSupportedToken() public {
        ...
        // Initial 2 tokens (USDC, USDT) + 1 new token = 3
        assertEq(tokenStorage.getSupportedTokens().length, 3);
    }
    ...
    function testRemoveSupportedToken() public {
        ...
        // Initial 2 tokens (USDC, USDT) + 1 new token - 1 removed = 2
        assertEq(tokenStorage.getSupportedTokens().length, 2);
    }
